...
export interface ModuleMassContribution {
  readonly instanceId: string;
  readonly moduleSku: string;
  readonly moduleName: string;
  readonly mass_kg: number;
  readonly barycenterX_mm: number;
  readonly axleLoads_kg: readonly number[];
}
...
export interface MassAnalysis {
  ...
  readonly moduleContributions: readonly ModuleMassContribution[];
}
...
export const evaluateMassDistribution = (context: ProjectContext): MassCheckResult => {
  ...
  const moduleContributions: ModuleMassContribution[] = [];
  ...
  for (const module of context.modules) {
    ...
    moduleContributions.push({
      ...
      moduleSku: module.module.sku,
      moduleName: module.module.name,
      mass_kg: mass,
      barycenterX_mm: module.obb.center.x,
      axleLoads_kg: contributions,
    });
  }
